...
/*We had thought of using a circular buffer like orientation (not exactly the template implementation of a circular buffer, but a tweaked one for our usecase) for creating
